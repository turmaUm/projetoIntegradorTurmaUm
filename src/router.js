...
const verificaSeClienteLogado = require('./middlewares/verificaSeClienteLogado')
const router = express.Router()

//Rotas cliente
router.get('/checkout-endereco', userSession, verificaSeClienteLogado, clientController.showEndereco)
router.get('/checkout-pagamento', userSession, verificaSeClienteLogado, clientController.showPagamento)
