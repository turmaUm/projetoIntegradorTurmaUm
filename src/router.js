...
router.get('/adm/produtos/editar/:id', verificaSeLogado, admController.ShowEditProduto)
router.put('/adm/produtos/atualizar/:id', verificaSeLogado, admController.atualizarProduto)
